...
Vehicle Insurance Prediction is an end-to-end Machine Learning project that predicts whether a customer is likely to purchase vehicle insurance.
The project covers the complete ML lifecycle including data processing, model training, evaluation, and production deployment using CI/CD on AWS.
It is built using FastAPI, Docker, GitHub Actions, and AWS (S3, ECR, EC2) 

The objective of this project is to predict whether a customer is likely to purchase vehicle insurance based on their personal details, vehicle information, and policy history. This helps insurance companies target the right customers, reduce marketing costs, and improve conversion rates.


# Problem Statement

Insurance companies need to efficiently identify customers who are more likely to purchase vehicle insurance in order to optimize marketing campaigns and improve conversion rates.

# 🔍 What I Built

- A Machine Learning model that learns from historical insurance data and predicts customer interest.

- A fully automated ML pipeline that handles data injestion , data processing, model training, evaluation, and versioning.

- A FastAPI so predictions can be accessed in real time.

- A CI/CD pipeline that automatically builds and deploys the application whenever code is updated.

- A cloud-based deployment using AWS services.
